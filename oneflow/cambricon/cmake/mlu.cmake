...
find_library(
  NEUWARE_CNPAPI_LIBRARY
  NAMES cnpapi
  PATHS ${NEUWARE_ROOT_DIR} $ENV{NEUWARE_HOME} $ENV{NEUWARE_PATH}
  PATH_SUFFIXES lib64 neuware/lib64)

if(NOT NEUWARE_CNPAPI_LIBRARY)
  message(
    FATAL_ERROR
      "Cambricon neuware cnpapi library is not found. Please set NEUWARE_ROOT_DIR to specify the search path."
  )
endif()
...
set(NEUWARE_LIBRARIES ${NEUWARE_CNRT_LIBRARY} ${NEUWARE_CNPAPI_LIBRARY} ${NEUWARE_CNDRV_LIBRARY} ${NEUWARE_CNNL_LIBRARY}
                      ${CNCL_LIBRARY})
