...
if(BUILD_MLU)
  include(${PROJECT_SOURCE_DIR}/oneflow/cambricon/cmake/mlu.cmake)
  add_subdirectory(${PROJECT_SOURCE_DIR}/oneflow/cambricon)
  target_include_directories(oneflow PRIVATE ${NEUWARE_INCLUDE_DIRS})
endif()
...
elseif(UNIX)
  ...
  if(BUILD_MLU)
    target_link_libraries(oneflow ${NEUWARE_LIBRARIES})
  endif()
elseif(WIN32)
